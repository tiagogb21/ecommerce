...
<footer class="w-full bg-gradient-to-b from-slate-950 to-gray-800">
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        <div class="grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-5">
            ...
            <div class="col-span-1">
                <h3 class="font-semibold text-gray-100">Company</h3>
            ...
            <div class="col-span-2">
                <h3 class="font-semibold text-gray-100">Stay up to date</h3>
        ...
        <div class="grid mt-5 sm:mt-12 gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
            <div class="flex items-center justify-between">
                <p class="text-sm text-gray-400">© {{ $currentYear }} E.COM. All rights reserved.</p>
            </div>
